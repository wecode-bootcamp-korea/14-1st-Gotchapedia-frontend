...
export const MOVIEDETAIL_SERVER_API = `http://3.35.216.109:8000/movies/${this.props.match.params.id}`;
...
export const OVERVIEW_SERVER_API = `http://3.35.216.109:8000/movies/${this.props.match.params.id}/detail`;
export const OVERVIEW_TOKEN = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6NH0.GOPhcT6nmt8M7Apx1rI-fvvQfSDIMTtWMe371hZ3t8E';

export const COMMENT_API = `http://3.35.216.109:8000/movies/${this.props.id}/comments`;
