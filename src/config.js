...
export const MYPAGE_API = 'http://localhost:3001/data/myPage.json';
// export const MYPAGE_API = 'http://10.58.0.152:8000/movie/my';
// export const WANNAWATCH_API = 'http://10.58.0.152:8000/movie/my?category=0';
// export const WATCHING_API = 'http://10.58.0.152:8000/movie/my?category=1';
...
export const PREFERRED_API =
  'http://localhost:3000/data/preferredCountryGenre.json';
// export const PREFERRED_API =
...
export const MYSTAR_API = 'http://localhost:3001/data/my_star.json';
...
export const MOVIEDETAIL_SERVER_API = 'http://10.58.2.172:8000/movie/23';
...
export const COMMNET_API = 'http://10.58.0.152:8000/comment/23';
